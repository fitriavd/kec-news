...
<head>
    ...
    <link rel="shorcut icon" type="text/css" href="<?php echo base_url() . 'assets/images/1665873309294.png' ?>">
    <!-- Bootstrap 3.3.6 -->
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                                ...
                                <div class="box-body">
                                    <table id="example1" class="table table-striped" style="font-size:13px;">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><img width="40" height="40" class="img-circle" src="<?php echo base_url() . 'assets/images/' . $pengguna_photo; ?>">
                                                    </td>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2023 By Fitria Vuspita Dewi</a>.</strong> All rights reserved.
        </footer>
